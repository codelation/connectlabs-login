...
//StoreInSession stores a key / value pair in the supplied http response
var StoreInSession = storeInSession
...
//GetFromSession gets a key / value pair from the supplied http request
var GetFromSession = getFromSession
